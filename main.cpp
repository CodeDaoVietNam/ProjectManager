...
int main() {
    ...
    loadData("data.bin", schoolYearList);
    User* head = nullptr;
    string filePath;
    cout << "Xin moi nhap file can import User :\n";
    getline(cin, filePath);
    importUsersFromCSV(head, filePath);
    while (true) {
        displayMainMenu();
        int choice;
        std::cin >> choice;
        ...
        if (choice == 2) {
            ...
            Input_Username_Password(head, username, password);
            ...
            if (currentUser->userType==1) {
                while (true) {
                    ...
                    std::cin >> choice;
                    if (choice == 11) {
                        handleStaffChoice(choice, schoolYearList);
                        break;
                    }
                    handleStaffChoice(choice, schoolYearList);
                }
                ...
                while (true) {
                    ...
                    std::cin >> choice;
                    if (choice == 3) {
                        handleStudentChoice(choice, currentUser, schoolYearList);
                        break;
                    }
                    handleStudentChoice(choice, currentUser, schoolYearList);
                }
